    ...
    <div class ="md:max-w-7xl mx-auto md:px-4">
        <div class="md:border-x border-slate-200 space-y-8 p-4 md:p-12">
            <div class="pt-14 md:pt-0">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-4">
                            ...
                            <div class="flex sm:flex-1">
                                <div class="h-full flex items-center justify-start">
                                    <a wire:navigate href="{{ route('index') }}"
                                        ...
                                        <h1 class="font-bold">
                                            {{ $siteSetting->name ? $siteSetting->name : config('app.name') }}
                                        </h1>
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <a href="{{ $item->link ?? null }}" title="{{ $item->title }}" target="_blank"
                                            ...
                                            @elseif ($item->type->value === SettingSiteTypeEnum::File->value)
                                                <img src="{{ asset('storage/' . $item->file) }}"
                                                    alt="{{ $item->title }}" class="w-auto h-auto">
                                            @endif
                                        </a>
                                    @endforeach
                                @else
...
<section class="w-full">
    <div class ="md:max-w-7xl mx-auto md:px-4">
        <div class=" border-slate-200 space-y-8 py-4">
            <div class="flex flex-row justify-center md:justify-between text-slate-500 text-sm gap-2">
                <div class="flex justify-center">
                    <h3>
                        {{ Str::title('copyright') }} &copy; {{ date('Y') }}
                    </h3>
                </div>
                <div class="flex justify-center">
