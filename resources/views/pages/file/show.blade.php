                    ...
                    <div class="w-full col-span-full md:col-span-8 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            @foreach ($record->attachment as $item)
                                <div
                                    class="relative flex items-center justify-center aspect-video w-full bg-slate-200 overflow-hidden rounded-xl">
                                    ...
                                    <div class="absolute bottom-4 left-0 pr-4">
                                        <a href="{{ route('file.download', $item) }}" target="__blank"
                                            class="inline-flex items-center bg-sky-500/50 backdrop-blur-xs rounded-r-xl text-white text-shadow-md hover:underline gap-2 px-4 py-2 ">
                                            {{ Str::title(__('unduh')) }}
